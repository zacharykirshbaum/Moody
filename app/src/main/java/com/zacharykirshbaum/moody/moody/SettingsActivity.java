...
//    }
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference logoutButton = (Preference) getPreferenceManager().findPreference("key_logout");
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        // Prevent SharedPreferences from trying to convert summary from HashSet to String
        if (preference instanceof MultiSelectListPreference) {
            summary = sharedPreferences.getStringSet(preference.getKey(), new HashSet<String>());
        } else {
            summary = sharedPreferences.getString(preference.getKey(), "");
        }
